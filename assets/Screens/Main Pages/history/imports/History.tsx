...
function CloseSmall() {
  return (
    <div className="absolute inset-[20%]" data-name="close-small">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="close-small">
          <path d="M6 6.5L18 18.5" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M6 18.5L18 6.5" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Term2() {
  return (
    <div className="bg-[#dc2626] overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Term 3">
      <CloseSmall />
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] items-end justify-center relative shrink-0 text-nowrap">
      <p className="font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[18px] relative shrink-0 text-[#dc2626] text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Failed
      </p>
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[#1f2933] text-[18px]">₹ 1,000</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="bg-[#1f2933] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[12px] shrink-0">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#fafafa] text-[12px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        All
      </p>
    </div>
  );
...
function Frame30() {
  return (
    <div className="content-stretch flex items-center px-[16px] py-[10px] relative rounded-[12px] shrink-0">
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[calc(50%+0.5px)] top-[52px] translate-x-[-50%]" data-name="Frame">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[#1f2933] text-[18px] text-nowrap">History</p>
    </div>
  );
}
