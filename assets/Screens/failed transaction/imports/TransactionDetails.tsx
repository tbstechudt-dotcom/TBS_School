import svgPaths from "./svg-d473a4nvqu";
  ...
  return (
    <div className="relative shrink-0 size-[36px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
        <g id="Frame">
          <path d={svgPaths.p3de28e00} fill="var(--fill-0, white)" id="Union" />
        </g>
      </svg>
    </div>
  );
...
function Term() {
  return (
    <div className="bg-[#dc2626] relative rounded-[50px] shrink-0" data-name="Term 3">
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[28px] ml-0 mt-0 relative text-[22px] text-nowrap text-white" style={{ fontVariationSettings: "'wdth' 100" }}>{`Payment  Failed`}</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-[105px]">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[22px] min-w-full relative shrink-0 text-[#6b7280] text-[15px] text-center w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Amount Paid
      </p>
      <p className="font-['SF_Pro:Bold',sans-serif] font-bold leading-[36px] relative shrink-0 text-[#dc2626] text-[26px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        ₹ 1,000
      </p>
    </div>
  );
...
function VuesaxLinearRepeat() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/repeat">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="repeat">
          <g id="Group">
            <path d={svgPaths.pbc28a60} id="Vector" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="1.5" />
            <path d={svgPaths.p3d33fc0} id="Vector_2" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="1.5" />
            <path d={svgPaths.p39bde380} id="Vector_3" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="1.5" />
            <path d={svgPaths.p33e10200} id="Vector_4" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="1.5" />
          </g>
...
function VuesaxLinearRepeat1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="vuesax/linear/repeat">
      <VuesaxLinearRepeat />
    </div>
  );
}
